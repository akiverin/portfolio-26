...
const LoginForm: React.FC = observer(() => {
  ...
  return (
    <AuthLayout mode="login">
      ...
      <form onSubmit={mode === 'login' ? handleLogin : handleReset} className={styles.form}>
        <div className={styles.header}>
          <Text view="p-28" tag="h1" weight="medium" className={styles.title}>
            {mode === 'login' ? 'Войти в аккаунт' : 'Восстановить пароль'}
          </Text>
          {mode === 'login' ? (
        ...
        <div className={styles.fields}>
          <div className={styles.field}>
            <Text tag="label" view="p-14" weight="medium" color="secondary" htmlFor="identifier">
              Email
            </Text>
            <Input
              id="identifier"
            ...
            {form.errors.identifier && (
              <Text id="identifier-error" view="p-14" color="accent" role="alert">
                {form.errors.identifier}
              </Text>
            )}
          </div>
          ...
          {mode === 'login' && (
            <div className={styles.field}>
              ...
              {form.errors.password && (
                <Text id="password-error" view="p-14" color="accent" role="alert">
                  {form.errors.password}
                </Text>
              )}
            </div>
